...
#lines(procs, (boost1+boost2)/2,  lwd=3, type="l", lty=3)
axis(2, las=1, at=seq(1,24))
axis(1, las=1, at=seq(1,24))
mygrid(seq(1,24), seq(1,24))
title("Зависимость производительности от числа процессоров", xlab="Число процессоров", 
ylab="Рост производительности в X раз", cex.main=2, cex.lab=1.7)
...
#lines(procs, (eff1+eff2)/2,  lwd=3, type="l", lty=3)
mygrid(seq(1,24), seq(0.2, 1.0, 0.1))
axis(2, las=1, at=seq(0.2, 1.0, by=0.1))
axis(1, las=1, at=seq(1,24))
title("Эффективность параллельного кода", 
xlab="Число процессоров", ylab="Эффективность", cex.main=2, cex.lab=1.7)
